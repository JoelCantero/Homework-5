...
```{r deciding-predictors, message=FALSE, results=FALSE, warning=FALSE }
...
```{r accuracy-precision, echo=FALSE, out.width="300px", out.height="150px", fig.align="center"}
...
```
```{r accuracy-precision-v2, echo=FALSE, message=FALSE, results=FALSE, warning=FALSE}
...
```{r accuracy-precision-v3, echo=FALSE, message=FALSE, results=FALSE, warning=FALSE}
